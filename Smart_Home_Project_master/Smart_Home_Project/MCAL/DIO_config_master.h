...
#define SCL_PIN (uint8)'C'
#define SDA_PIN (uint8)'C'

#define SCL_PIN_NUMBER  (uint8)0
#define SDA_PIN_NUMBER  (uint8)1
...
#define ADMIN_LED_PIN  (uint8)5
#define GUEST_LED_PIN  (uint8)6
#define BLOCK_LED_PIN  (uint8)7

// keypad Macros 
#define KEYPAD_PORT			(uint8)'A'
